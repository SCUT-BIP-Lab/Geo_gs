...
class OptimizationParams(ParamGroup):
    def __init__(self, parser):
        ...
        self.mlp_view_1_lr_init = 0.005
        self.mlp_view_1_lr_final = 0.00001
        self.mlp_view_1_lr_delay_mult = 0.01
        self.mlp_view_1_lr_max_steps = 30_000

        self.mlp_view_2_lr_init = 0.005
        self.mlp_view_2_lr_final = 0.00001
        self.mlp_view_2_lr_delay_mult = 0.01
        self.mlp_view_2_lr_max_steps = 30_000
